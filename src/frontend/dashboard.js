        ...
        <div class="section-card">
          <div class="section-header">
            <div>
              ...
              <div class="section-subtitle">Schichten und Postfach</div>
            </div>
          </div>
        ...
        <div class="section-card">
          <div class="section-header">
            <div>
              ...
              <div class="section-subtitle">Objekt-Wiki</div>
            </div>
          </div>
          ...
          <div class="button-stack">
            ...
            <button id="btnVideos" class="btn blue">Videos</button>
            <button id="btnWaste" class="btn blue">Müllplan</button>
            <button id="btnKeys" class="btn blue">Schlüssel</button>
            <button id="btnDanger" class="btn blue">Gefahren- und Anwendungshinweise</button>
          </div>
        </div>
        ...
        <div class="section-card">
          <div class="section-header">
            <div>
              ...
              <div class="section-subtitle">Tickets und Beschwerden</div>
            </div>
          </div>

          <div class="button-stack">
            <button id="btnTickets" class="btn yellow">Tickets</button>
            <button id="btnComplaints" class="btn yellow">Beschwerden</button>
            <button id="btnNotes" class="btn yellow">Sofortnotizen</button>
          </div>
        </div>
        ...
        <div class="section-card">
          <div class="section-header">
            <div>
              ...
              <div class="section-subtitle">Verwaltung</div>
            </div>
          </div>

          <div class="button-stack">
            <button id="btnReplacement" class="btn orange">Vertretung</button>
            <button id="btnOrders" class="btn orange">Bestellungen</button>
